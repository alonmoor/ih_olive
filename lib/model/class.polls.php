...
class polls { // open the class definition
  ...
  'username' => 'alon',
  'password' => 'qwerty',
  'hostspec' => '192.168.0.204',
  'database' => 'dec',
  'charset' => 'utf8',
); 
        // implement db object
      $this->_oConn =& DB::connect(DSN);
       //$this->_oConn =& DB::connect($DB_DSN);
       //$this->_oConn =& MDB2::connect($DB_DSN);
       //$this->_oConn =& MDB2::connect(DSN1);
        ...
        $stmt = "SET NAMES 'utf8'";
        $stmt1="SET CHARACTER SET utf8";

        
        
       // $result =$this->_oConn->query ($stmt);
          
       if(  DB::isError($result)){
       	die ("set names utf-8 failed: " . $result->getMessage () . "\n");
       }
        
     
       //$result1= $polls->setFetchMode(DB_FETCHMODE_ASSOC);
...
//       }
       ...
       $result2=$this->_oConn->Query("SET CHARACTER SET UTF8");
