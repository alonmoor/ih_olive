...
class DBTreeView{
	 ...
	 */
	private function __construct(array $rootAttributes, $pathToLibrary, $id,$id2="",$count_form=""){
		$this->id = $id;
		$this->id2 = $id2;
	   ...
	   //$this->defaultClosedIcon =DEFAULT_SINGLE_ICON;
	}
function htmlspecial_utf8(&$txt) {
  return htmlspecialchars($txt, ENT_COMPAT, "UTF-8"); }
	 ...
	 * @return DBTreeView the new treeview.
	 */
	public static function createTreeView(array $rootAttributes, $pathToLibrary, $id,$id2="",$count_form=""){
		return new self($rootAttributes, $pathToLibrary, $id,$id2,$count_form);
	}	
...
/*****************************/
if($this->id2 != NULL){
			print(sprintf("params.id2 = \"%s\";\n", 
			   DBTreeView::escapeJSString($this->id2)));
}				
/*****************************/	
/*****************************/
if($this->count_form != NULL){
			print(sprintf("params.count_form = \"%s\";\n", 
			   DBTreeView::escapeJSString($this->count_form)));
}				
/*****************************/			
...
?> 
	 ...
	 new  DBTreeView.TreeView(params); 
//try{
//	
//  new  DBTreeView.TreeView(params);
// 
...
/********************************************************************/
public function printTreeViewScript2(){
?>
