...
/**********************************************************************************/			
			...
			if(array_item ($_POST,'arr_dest_forumsType') )
			 ...
			 if(!array_item ($_POST,'arr_dest_forumsType') 
			   &&  ($_POST['form']['src_forumsType'][0]   )
			   && is_array($_POST['form']['src_forumsType']))
			 $formdata['dest_forumsType']=$_POST['form']['src_forumsType'];
			 
			 
//			  if(!array_item ($_POST,'arr_dest_forumsType') 
//			   &&  ($_POST['form']['dest_forumsType'][0]   )
//			   && is_array($_POST['form']['dest_forumsType']))
...
///////////////////////			 
			...
			if(!array_item ($_POST,'arr_dest_appoints') 
			   &&  ($_POST['form']['src_appoints'][0]   )
			   && is_array($_POST['form']['src_appoints']))
			 $formdata['dest_appoints']=$_POST['form']['src_appoints'];
//////////////////////			 
		   ...
		   if(!array_item ($_POST,'arr_dest_managewrss') 
			   &&  ($_POST['form']['src_managers'][0]   )
			   && is_array($_POST['form']['src_managers']))
			 $formdata['dest_managers']=$_POST['form']['src_managers'];	
////////////////////////			
			...
			if(!array_item ($_POST,'arr_dest_managersType') 
			   &&  ($_POST['form']['src_managersType'][0]   )
			   && is_array($_POST['form']['src_managersType']))
			 $formdata['dest_managersType']=$_POST['form']['src_managersType'];	
			 
////////////////////////			
			
			if(array_item ($_POST,'arr_dest_users') )
			$formdata['dest_users']=$_POST['arr_dest_users'];
			
			
			if(!array_item ($_POST,'arr_dest_users') 
			   &&  ($_POST['form']['src_users'][0]   )
			   && is_array($_POST['form']['src_users']))
			 $formdata['dest_users']=$_POST['form']['src_users'];	
/**************************************************************************************/	
$formdata['forum_status']=$_POST['forum_status'];
$formdata['forum_allowed']=$_POST['forum_allowed'];				 				 
/**************************************************************************************/			
			
			if(!validate($formdata,$form)){
			...
			if($managersIDs =$frm->save_manager1($formdata)){
				 if($catIDs=$frm->save_category_ajx($formdata)){
					 if($catTypeIDs=$frm->save_managerType_ajx($formdata)){
							...
							if ($frm->add_forum($formdata,$appointsIDs,$managersIDs,$catIDs,$catTypeIDs,$dateIDs,$appointdateIDs,$managerdateIDs,$form)) {
