 ...
 */
//////////////////////////////////////////////
DBTreeView.TreeView = function(params){//////DEALING WITH PARAMS put object from php constaractor to the teeview object js
////////////////////////////////////////////	
	...
	treeView.id2 = params.id2;
	treeView.count_form= params.count_form;
...
/************************************/	
 ...
 var frmID= this.id2;
 var count_form=this.count_form;
 var num=parseInt(count_form);
 
 var page_num=parseInt(count_form-1);
 
 
 
 if(count_form==1){ 

	 var num=Math.round(10*count_form);	 
 }
 else{  
 ...
 if(this.id==='treev1'+frmID ){
		
//	 document.getElementsByTagName('table')[num].innerHTML  ="<div class=\"treeView\" id="+treeView.id+">"+treeView.loadingMessage+"</div>";
	 document.getElementsByTagName('table')[num].innerHTML  ="<tr><td><div class=\"treeView\" id="+treeView.id+">"+treeView.loadingMessage+"</div></td></tr>";	 		
	 	 }

 if(this.id==='treev2'+frmID ){ 
	 
	  document.getElementsByTagName('table')[num+1].innerHTML ="<div class=\"treeView\" id=\""+treeView.id+"\">"+treeView.loadingMessage+"</div>";
...
//-------------------------------------------------------------------------------------------------------- 
 ...
 if(this.id==='treev2'+frmID ){ 
	...
	//  document.getElementsByTagName('table')[num+1].innerHTML ="<table><tr><td><div class=\"treeView\" id=\""+treeView.id+"\">"+treeView.loadingMessage+"</div></td></tr></table>";
	//  document.write("<div class=\"treeView\" id=\""+treeView.id+"\">"+treeView.loadingMessage+"</div>"); 
 }	  
