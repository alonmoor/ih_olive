...
/*****************************************************************************************************/	    
		...
		//	if( (this.elem.id=='treev1' || this.elem.id=='treev1'){
...
//	 }
	...
	//   if(!( document.getElementsByTagName('table')[12].innerHTML==undefined) && !( document.getElementsByTagName('table')[13].innerHTML==undefined) ){	  
	  if(this.id==='treev1' ){
	 		 ...
	 		 document.getElementsByTagName('table')[10].innerHTML  ="<div class=\"treeView\" id="+treeView.id+">"+treeView.loadingMessage+"</div>";
	 		
	 	 }

		 if(this.id==='treev2' ){ 
			 
	  		 document.getElementsByTagName('table')[11].innerHTML ="<div class=\"treeView\" id=\""+treeView.id+"\">"+treeView.loadingMessage+"</div>";
