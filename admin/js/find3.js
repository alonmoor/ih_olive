 ...
 $(document).ready(function() { 
	 ...
	 showhide($("h5[class^=my_usr_frm]"),$("h6[class^=my_usr_frm_2]"));
	 
	 showhide($("h5[class^=my_decfrm]"),$("h6[class^=my_decfrm_2]"));
	 
	 
	// showhide($("#my_usr_frm_content_2"),$("#my_usr_frm_content"));
	// $('#ajaxbox.dhtmlwindow').addClass('paginated');	 	
	 
	// $('form.paginated').wrapAll("<div class='paginated'></div>");
...
//		 '</div>').Before('div#content_page');
	 
	 
	 //<div id="my_next" class="paginated" style="width:90%;float:right;">   
/*******************************************************************************************************************/	
//	 $('#modal_window').find('.div_count_dec').MyPagination({height: 400, fadeSpeed: 400});
//	 $('<div class="pagination">'+
//		     '<ul>'+
//		         '<li><a href="#" id="prev" class="prevnext">« Previous</a></li>'+
//		         '<li><a href="#" id="next" class="prevnext">Next »</a></li>'+
