...
switch ($_REQUEST['mode'] ) {
    ...
    case "update":
        ...
        } elseif(isset($_GET['decID']) && $_GET['decID']   ) {
            $decID = $_GET['decID'];
            update_dec($decID);

        }else if( (isset($_POST['form']['decID']) && $_POST['form']['decID'] ) ){
            $decID = $_POST['form']['decID'];
            update_dec($decID);
        }
//--------------------------------------------------------------------------
            ...
            $decID = $_POST['form']['decID'];
            if (!empty($_POST['form']['dest_forums'][0]) && $_POST['form']['dest_forums'][0] == 'none')
                unset($_POST['form']['dest_forums'][0]);

            if (!empty($_POST['form']['dest_forums']) && count($_POST['form']['dest_forums']) == 0)
                unset($_POST['form']['dest_forums']);

            if (!empty($_POST['arr_dest_forums'][0]) && $_POST['arr_dest_forums'][0] == 'none')
                unset($_POST['arr_dest_forums'][0]);

            if (!empty($_POST['arr_dest_forums']) && count($_POST['arr_dest_forums']) == 0)
                unset($_POST['arr_dest_forums']);

            /*********************************************************************************/


            if (!empty($_POST["form"]["dest_forums$decID"][0]) && $_POST["form"]["dest_forums$decID"][0] == "none") {
                unset($_POST["form"]["dest_forums$decID"][0]);
            }

            if (!empty($_POST["form"]["dest_forums$decID"]) && count($_POST["form"]["dest_forums$decID"]) == 0)
                unset($_POST["form"]["dest_forums$decID"]);

            if (!empty($_POST["arr_dest_forums$decID"][0]) && $_POST["arr_dest_forums$decID"][0] == "none")
                unset($_POST["arr_dest_forums$decID"][0]);

            if (!empty($_POST["arr_dest_forums$decID"]) && count($_POST["arr_dest_forums$decID"]) == 0)
            ...
            /*********************************************************************************/
            if (!empty($_POST["form"]["dest_decisionsType$decID"][0]) && $_POST["form"]["dest_decisionsType$decID"][0] == "none")
                unset($_POST["form"]["dest_decisionsType$decID"][0]);

            if (!empty($_POST["form"]["dest_decisionsType$decID"]) && count($_POST["form"]["dest_decisionsType$decID"]) == 0)
            ...
            if (!empty($_POST["arr_dest_decisionsType$decID"][0]) && $_POST["arr_dest_decisionsType$decID"][0] == "none")
                unset($_POST["arr_dest_decisionsType$decID"][0]);

            if (!empty($_POST["arr_dest_decisionsType$decID"]) && count($_POST["arr_dest_decisionsType$decID"]) == 0)
            ...
            if (isset($formdata["dest_forums$decID"]) && $formdata["dest_forums$decID"] && $formdata["dest_forums$decID"] != 'none'
                && is_array($formdata["dest_forums$decID"]) && (isset($formdata["dest_forums$decID"]) && count($formdata["dest_forums$decID"]) > 0)
            ) {
                $i = 0;
                ...
                $formdata["dest_forums$decID"] =isset($formdata['dest_forums_test']) ? $formdata['dest_forums_test'] : '';
...
/***************************************************************/
                ...
                if (!empty($_POST['arr_dest_forums']) && $_POST['arr_dest_forums']) {
                    $formdata1['dest_forums'] = $_POST['arr_dest_forums'];
                }

                if (!empty($_POST['arr_dest_decisionsType']) && $_POST['arr_dest_decisionsType']) {
...
//////////////////////////////////////////////////////////////////////////////////
    ...
    case "take_data":
        ...
        if (!empty(_POST["arr_dest_decisionsType$decID"]) && count($_POST["arr_dest_decisionsType$decID"]) == 0)
            unset($_POST["arr_dest_decisionsType$decID"]);
        /*********************************************************************************/
        $formdata = isset($_POST['form']) ? $_POST['form'] : null;
        if (array_item($_POST, "arr_dest_forums") && (is_array($_POST["arr_dest_forums"]))) {
            $formdata["dest_forums"] = $_POST["arr_dest_forums"];
        }
        if (array_item($_POST, "arr_dest_forums$decID") &&
...
//$formdata=$_POST['form'];
    ...
    case "list":
        if(isset($_POST['form'])) {
            ...
            if ($showMyform && !(isset($_POST['form']['btnLink1']) && $_POST['form']['btnLink1']) && $page <= 1) {
                $dec = new decisions();
        ...
        elseif(isset($_POST['form']['btnLink1']) && $_POST['form']['btnLink1'] && $_POST['form']){
            ...
            $decID=isset($_REQUEST['decID']) ? $_REQUEST['decID'] : '';
            $dec = new decisions();
            $dec->print_form();
        }
}
...
$subcategories =   (isset($_POST['form']['subcategories'])) && $_POST['form']['subcategories'] ? $_POST['form']['subcategories'] : '';
$deleteID =  (isset($_POST['deleteID'])) && $_POST['deleteID'] ?  $_POST['deleteID'] : '';

    if(empty ($insertID)){
        $insertID =   (isset($_POST['form']['decID'])) && $_POST['form']['decID'] ? $_POST['form']['decID'] : '';
    }


    if(empty ($deleteID)){
        $deleteID =   (isset($_POST['form']['deleteID'])) && $_POST['form']['deleteID'] ? $_POST['form']['deleteID'] : '';
    }
...
function update_decision($formdata){
    ...
    if(isset($formdata["new_forum$decID"]) && $formdata["new_forum$decID"])
        $formdata["new_forum"]=$formdata["new_forum$decID"];



    if(isset($formdata["insert_forum$decID"]) && $formdata["insert_forum$decID"])
    ...
    if(isset($formdata["new_decisionType$decID"]) && $formdata["new_decisionType$decID"])
        $formdata["new_decisionType"]=$formdata["new_decisionType$decID"];



    if(isset($formdata["insert_decisionType$decID"]) && $formdata["insert_decisionType$decID"])
