...
<!--<script type="text/javascript" src="ajax_multi.js"></script>-->
...
$().ready(function(){
	...
	$("#tasklist").sortable({cancel:'span,input,a,textarea', delay: 150, update:orderChanged, start:sortStart});
...
global $db;
// DEFINE SQL QUERY
$getTask_sql	=	"SELECT * FROM todolist INNER JOIN users 
...
// GET ALL USER
$getUser_sql	=	"SELECT * FROM users_tmp
...
<div class="form-row"><span class="h"><?php __('priority');?></span> <SELECT name="prio"><option value="3">+3</option><option value="2">+2</option><option value="1">+1</option><option value="0" selected>&plusmn;0</option><option value="-1">&minus;1</option></SELECT> 
...
<span class="prio-pos" onClick="prioClick(1,this)">+1</span>
 <span class="prio-pos" onClick="prioClick(2,this)">+2</span>
 <span class="prio-pos" onClick="prioClick(3,this)">+3</span>
</div>
...
<!--<div id="footer"><div id="footer_content">Powered by <strong><a href="http://www.pozdeev.com/mytinytodo/">myTinyTodo</a></strong> v1.2.3 </div></div>-->
