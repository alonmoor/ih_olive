...
//$('#submitbutton'+decID).click(function() {
//           $('my_dec'+decID).hide();
//        });
...
// 	  });
//
// 	  $('form#addtask'+decID+forum_decID).click(function(){
// 	    console.info($(this).serialize());
// 	    return false;
// 	  })
// 	alert( ($('#button_action').val($(this).attr('name'))  ));
 //	alert(forum_decID);
 
 
// $('form#addtask'+decID+forum_decID ).click( function(){
//  	 
//	 var link =	$(this).find(":button").attr('name');
//	 alert(link);
//  	});
...
//    $('form#addtask'+decID+forum_decID ).click( function(){
//		  	 
//			 var link =	$(this).find(":hidden").attr('value');
//			   			 
//			  alert (link);
//		  	});
/*****************************************************************************************************/
...
/***************************************************************************************************/ 
 	...
 	$("#edittags"+decID+forum_decID).autocomplete('/alon-web/olive/admin/ajax2.php?suggestTags', {scroll: false, multiple: true, selectFirst:false, max:8});
...
/**********************************************************************************/
  ...
  //  tabs.resizable(resizeOpts);
   $("#page_taskedit"+decID+forum_decID).resizable(  ); 
 	 // $("#edittask"+decID+forum_decID).resizable(resizeOpts); 
...
<div id="multiview<?php echo $decID;echo $forum_decID;?>" style="display:none">
 ...
 <div class="li" onClick="loadUsers2send2(<?php echo " '".ROOT_WWW."/admin/' "; ?>,<?php echo $decID;?>,<?php echo $forum_decID;?>,<?php echo $mgr;?>);multiviewClose2(<?php echo $decID;?>,<?php echo $forum_decID;?>);">
...
<div class="form-row">
     <input id="send<?php echo $decID;echo $forum_decID;?>" type="submit" class="button" name="sendMultiTask2users<?php echo $decID;echo $forum_decID;?>" value="שלח משימה" onClick="return SubmitTask2users2(this,<?php echo $decID;?>,<?php echo $forum_decID;?>,<?php echo " '".ROOT_WWW."/admin/' "; ?>);this.blur();return false" />
...
<!-- ----------------------------------------------SHOW_USER_VIEW--------------------------------------------------- -->
  ...
  <h3>
   ...
   onClick="showUserview2(this,<?php echo " '".ROOT_WWW."/admin/' "; ?>,<?php echo $decID;?>,<?php echo $forum_decID; ?>);">
 ...
 <span id="usersort<?php echo $decID;echo $forum_decID;?>" 
   onClick="showuserSort2(this,<?php echo $decID;?>,<?php echo $forum_decID; ?>);"  title="<?php __('sortByHand');?>">
...
<div class="form-row">
     ...
     <input name="duedate1" id="duedate1<?php echo $decID;echo $forum_decID;?>" value="" class="in100" title="Y-M-D, M/D/Y, D.M.Y, M/D, D.M" autocomplete="off" />
