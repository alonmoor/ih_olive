...
function prepareTaskStr(item)
{
	...
	return '<li id="taskrow_'+id+'" class="'+(item.compl?'task-completed ':'')+item.dueClass+'" onDblClick="editTask('+id+')"><div class="task-actions">'+
		...
		'<a href="#" onClick="return deleteTask('+id+')"><img src="'+img.del[0]+'" onMouseOver="this.src=img.del[1]" onMouseOut="this.src=img.del[0]" title="'+lang.actionDelete+'"></a>'+
		
		
		
		
//		 '<a href="#"  >'+
//		  '<img src="'+img.dairy[0]+'" class="href_modal1" onMouseOver="this.src=img.dairy[1]" onMouseOut="this.src=img.dairy[0]" title="'+lang.actionDairy+'">'+
...
//	       '<img src="'+img.showformewin[0]+'" onMouseOver="this.src=img.showformewin[1]" onMouseOut="this.src=img.showformewin[0]" title="'+lang.actionDairy+'">'+
//	     '</a>'+
		...
		//		 '<a href="#" onClick="return editUsertask('+id+',\''+url+'\','+id+')">'+
//	       '<img src="'+img.dairy[0]+'" onMouseOver="this.src=img.dairy[1]" onMouseOut="this.src=img.dairy[0]" title="'+lang.actionDairy+'">'+
//	     '</a>'+
...
{
	//alert(el); 
	if(el.id && $.inArray(el.id, id) != -1){//alert("true");
		return true;}
	if(!el.parentNode) return null;
