...
$().ready(function(){
	...
	mytinytodo.init({
		...
		showdate: <?php echo ( !isset($_GET['pda'])) ? "true" : "false"; ?>,
...
<h3>
		<span id="taskview" class="mtt-menu-button">
			<span class="btnstr"><?php _e('tasks');?></span> 
...
<div id="page_taskedit" style="display:none">
	...
	<form id="taskedit_form" name="edittask" method="post">
		...
		<div class="form-row"><div class="h"><?php _e('task');?></div>
			 <input type="text" name="task" value="" class="in500" maxlength="250" />
		</div>
		
		
		<div class="form-row"><div class="h"><?php _e('note');?></div> 
