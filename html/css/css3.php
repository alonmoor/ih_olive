	...
	<style type="text/css" media="screen">
      ...
      #content .sidebar ul li.active {
        ...
        background: linear-gradient(top, #7bb5db, #4775b8);
         filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#0073A3',endColorstr='#C3EDFF');
      }
      ...
      #content .main {
        -moz-box-shadow: inset 0px 1px 3px #7f7f7f;
        -webkit-box-shadow: inset 0px 1px 3px #7f7f7f;
  ...
  <div id="content">
    <div class="sidebar">
      ...
      <ul>
        ...
        <li><a>Marketing</a></li>
        <li><a>Ops</a></li>
        <li> <a href="dynamic_5.php" >blablabala</a></li>
      </ul>
