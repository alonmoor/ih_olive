...
/*********************************************/      
  ...
  if($_SERVER['SCRIPT_NAME'] == ROOT_WWW."/admin/mult_dec_ajx.php" || $formdata['mult_dec_ajx']==1){
...
<fieldset style="margin-left:20px;margin-right:40px;background: #94C5EB url(../images/background-grad.png) repeat-x"><legend>החלטות עין השופט</legend>
...
//echo("<td class='myformtd'>");
 ...
 // form_url("categories.php","ערוך סוגי החלטות",2 );
...
}elseif(!empty($formdata['src_forums']) && $formdata['src_forums'][0]!=0 && !$formdata['dest_forums']){
...
//           echo '<td class="myformtd" style="width:10px;overflow:hidden;">'; 
//		    form_textarea1("new_forum", array_item($formdata, "new_forum"),14,5, 1);
//		   echo '</td>'; 
...
$decID=$formdata['decID'];
		...
		$sql="SELECT forum_decName from forum_dec WHERE forum_decID=$frm_id ";
		 ...
		 <div class="form-row"> 
		   <span class="h">חברי פורום בעת קבלת ההחלטה:<input id="forum_decName" name="forum_decName"  type="text" value="<?php echo $forum_name;?>" class="mycontrol"/></span> 
	    <br/> 
        </div> 
...
?>
 ...
 <input type="button"  class="mybutton"  id="my_button_<?php echo $frm_id; echo $row->userID ;?>"  value="ערוך משתמש" onClick="return editReg_user(<?php echo $row->userID;?>,<?php echo " '".ROOT_WWW."/admin/' "; ?> );" ; return false; />
<?php  }elseif(!($level)){?>
     
<input type="button"  class="mybutton"  id="my_button_<?php echo $frm_id; echo $row->userID ;?>"  value="צפה בפרטי משתמש" onClick="return editReg_user(<?php echo $row->userID;?>,<?php echo " '".ROOT_WWW."/admin/' "; ?> );" ; return false; />     
<?php }?>     
...
echo '<tr>
 ...
 $sql="select parentDecID1 from decisions where decID= " . $db->sql_string($formdata['decID']) ;
   ...
   echo '</td>';
     ...
     if(!empty($formdata["decID"])){
 			?>
 			<button class="green90x24" type="submit" name="submitbutton_save<?php echo $formdata['decID'];?>"  id="submitbutton_save<?php echo $formdata['decID'];?>" >שמור</button>
 			<?php 
...
<form  onSubmit="return saveUser3(this,<?php echo " '".ROOT_WWW."/admin/' "; ?>);"  name="edituser"   id="edituser" >
...
<div class="form-row">
  <span class="h"><?php __('priority');?></span> 
    ...
    <input name="duedate3" id="duedate3" value="" class="in100" title="Y-M-D, M/D/Y, D.M.Y, M/D, D.M" autocomplete="off" />
</div>
...
<div class="form-row"><span class="h"><?php __('full_name');?></span><br> <input type="text" name="full_name" id="full_name" value="" class="in200" maxlength="50"   /></div>
 
 <div class="form-row"><span class="h"><?php __('user');?></span><br> <input type="text" name="user" id="user" value="" class="in200" maxlength="50"   /></div>
 
 <div class="form-row"><span class="h"><?php __('upass');?></span><br> <input type="text" name="upass" id="upass"  value="" class="in200" maxlength="50" /></div>
 <div class="form-row"><span class="h"><?php __('email');?></span><br> <input type="text" name="email"  id="email"    value="" class="in200" maxlength="50" /></div>
 <div class="form-row"><span class="h"><?php __('phone');?></span><br> <input type="text" name="phone"  id="phone"    value="" class="in200" maxlength="50" /></div>
 <div class="form-row"><span class="h"><?php __('note');?></span><br>  <textarea name="note" id="note" class="in500"></textarea></div>
 <div class="form-row"><span class="h"><?php __('tags');?></span><br>  <input 	type="text" name="tags" id="edittags1" value="" class="in500" maxlength="250" /></div>
 <div class="form-row">
  <?php if($level){?>
   <input type="submit" id="edit_usr" value="<?php __('save');?>" onClick="this.blur()" />
  <?php }?>  
   <input type="button" value="<?php __('cancel');?>" onClick="canceluserEdit3();this.blur();return false" />
...
<script  language="JavaScript" src="<?php print JS_ADMIN_WWW ?>/decision.js"    type="text/javascript"></script>
 ...
 <h4 class="my_main_fieldset<?php echo $formdata['decID']?>" style="height:15px;cursor:pointer;"></h4>
...
<form  style="width:98%;"  method="post"  name="decision_<?php echo $formdata['decID']?>" id="decision_<?php echo $formdata['decID']?>" action="../admin/dynamic_5c.php" 
 ...
 <fieldset id="main_fieldset<?php echo $formdata['decID']?>" style="background: #94C5EB url(../images/background-grad.png) repeat-x;"><legend style="color:brown; ">החלטות עין השופט</legend>
...
<h4 class="my_menu_items_dec_title" style="height:15px;cursor:pointer;"></h4>
 
 
 <div id="my_error_message<?php echo $decID;?>"  name="my_error_message<?php echo $decID;?>"></div>
   
  
    <ul id="menu_items_dec<?php echo $decID;?>"  name="menu_items_dec<?php echo $decID;?>"  class="menu_items_dec<?php echo $formdata['decID'];?>" style="overflow:hidden" >  
     <input type=hidden name="menu_items_dec_hidden<?php echo $formdata['decID']?>" id="menu_items_dec_hidden<?php echo $formdata['decID']?>"  value="<?php echo $formdata['decID']?>" />  
...
$formdata["dest_managers$decID"]=$formdata["dest_managers"];
$formdata["dest_userIDs$decID"]=$formdata["dest_userIDs"];
...
if($formdata["dest_forums$decID"][0] && $formdata["dest_forums$decID"][0]!='none' ){	 		
...
if($formdata["src_forums$decID"] && $formdata["src_forums$decID"][0]!=0 && !$formdata["dest_forums$decID"]){
...
<tr>
     <td>
      <table class="myformtable1" style="height:100px;width:98%;" id="conn_table<?php echo $decID;?>">
      <tr>
<?php  
...
<tr><td   id="my_td2<?PHP echo $decID;?>">

&nbsp;&nbsp;
<button class="green90x24" type="submit"   name="submitbutton_<?php echo $formdata['decID'];?>"  id="submitbutton_<?php echo $formdata['decID'];?>"  
 onclick="return  prepSelObject(document.getElementById('dest_forums<?php echo $formdata['decID'];?>'))
 ,prepSelObject(document.getElementById('dest_decisionsType<?php echo $formdata['decID'];?>'));" >שמור</button> 


		
 &nbsp;&nbsp;
<button class="green90x24" type="button" name="submitbutton1_<?php echo $formdata['decID'];?>"  
id="submitbutton1_<?php echo $formdata['decID'];?>" >→משימות</button>


 
&nbsp;&nbsp;
<button class="green90x24" type="button" name="submitbutton2_<?php echo $formdata['decID'];?>"
  id="submitbutton2_<?php echo $formdata['decID'];?>" >משימות← </button>


  
&nbsp;&nbsp;
<button  class="green90x24" type="submit" name="submitbutton3_<?php echo $formdata['decID'];?>" 
 id="submitbutton3_<?php echo $formdata['decID'];?>"
 onclick="return  prepSelObject(document.getElementById('dest_forums<?php echo $formdata['decID'];?>'))
		 ,prepSelObject(document.getElementById('dest_decisionsType<?php echo $formdata['decID'];?>'));" >העלה מידע</button>
		 
		 

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
<button class="green90x24" type="submit" name="btnDelete_<?php echo $formdata['decID'];?>"  id="btnDelete_<?php echo $formdata['decID'];?>" >מחק החלטה</button>
...
/*************************************************************/ 	       
         ...
         //  form_button5("btnLink6_$decID",  "שנה קישור ריאשון לפי חיפוש","button","btnLink6_$decID");
			...
			form_hidden("insertID", $formdata["insertID"]);
			?>
	<button class="green90x24" type="submit" value="שמור/עדכן" ,name="submitbutton_<?php echo $formdata['decID'];?>"  id="submitbutton_<?php echo $formdata['decID'];?>"  
      onclick="return  prepSelObject(document.getElementById('dest_forums<?php echo $formdata['decID'];?>')),
      prepSelObject(document.getElementById('dest_decisionsType<?php echo $formdata['decID'];?>'));">שמור/עדכן</button>     
...
echo '<tr>
     <td>
     <table class="myformtable1" style="border:0;" id="conn_table<?php echo $decID;?>">
     <tr><td>';
form_hidden("decID", $formdata["decID"]);
?>
...
<form  onSubmit="return saveUser3(this,<?php echo " '".ROOT_WWW."/admin/' "; ?>);"  name="edituser"   id="edituser" >
<input type="hidden" name="Request_Tracking_Number_1" id="Request_Tracking_Number_1" value="" />
<input type="hidden" name="Request_Tracking_Number_1" id="Request_Tracking_Number_2" value="" />
<input type="hidden" name="Request_Tracking_Number1" id="Request_Tracking_Number1" value="" />
<input type="hidden" name="Request_Tracking_Number2" id="Request_Tracking_Number2" value="" />
<input type="hidden" name="id" value="" />
<input type="hidden" name="forum_decID" id="forum_decID" value="<?php echo $formdata['forum_decision']; ?>" />
...
<table id="my_dec<?php echo $decID; ?>" ><tr><td> 
 <?php  	
...
function build_form_dec_ajxMult(&$formdata) {
 ...
 <h4 class="my_Dectitle_<?php echo $formdata['decID'];?>" style="height:15px"></h4>    
<div id="main_content<?php echo $formdata['decID'];?>"> 
 ...
 <form  method="post"  name="decision_<?php echo $formdata['decID']?>" id="decision_<?php echo $formdata['decID']?>" action="../admin/dynamic_5c.php" 
  ...
  <fieldset id="main_fieldset<?php echo $formdata['decID']?>" style="margin-left:80px;background: #94C5EB url(../images/background-grad.png) repeat-x"><legend><h1 style="color:brown;width:80%;">החלטות עין השופט</h1></legend>
   
     <div id="decision_b_<?php echo $formdata['decID']?>"  name="decision_b_<?php echo $formdata['decID']?>"></div>      
    <div id="decision_a_<?php echo $formdata['decID']?>"  name="decision_a_<?php echo $formdata['decID']?>"></div>
  
  
<h4 id="my_menu_items_dec_title<?php echo $formdata['decID'];?>" class="my_menu_items_dec_title<?php echo $formdata['decID'];?>" style="height:15px;cursor:pointer;"></h4>
 <div id="my_error_message<?php echo $formdata['decID'];?>"  name="my_error_message<?php $formdata['decID'];?>"></div>
  <ul id="menu_items_dec<?php echo $formdata['decID'];?>"  name="menu_items_dec<?php echo $formdata['decID'];?>"  class="menu_items_dec<?php echo $formdata['decID'];?>">   
  <input type=hidden name="menu_items_dec_hidden<?php echo $formdata['decID']?>" id="menu_items_dec_hidden<?php echo $formdata['decID']?>"  value="<?php echo $formdata['decID']?>" />    
  
<!--   <div id="decision0_<?php echo $formdata['decID']?>"  name="decision0_<?php echo $formdata['decID']?>" style="overflow:auto;hieght:400px;"></div>  -->
  <div id="decision0_<?php echo $formdata['decID']?>"  name="decision0_<?php echo $formdata['decID']?>"   style="overflow:auto;hieght:1000px;"></div>
   <div id="decision1_<?php echo $formdata['decID']?>"  name="decision1_<?php echo $formdata['decID']?>"></div>
    <div id="decision2_<?php echo $formdata['decID']?>"  name="decision2_<?php echo $formdata['decID']?>"></div>
  ...
  <table id=""myformtable1<?php echo $formdata['decID']?>"   style="width:95%;align:center;border:0;" >
		 ...
		 ?>
          ...
          <script  language="JavaScript" type="text/javascript">
                   $(document).ready(function(){
	            	...
	            	$("#dec_date"+decID).datepicker( $.extend({}, {showOn: 'button',
		                               buttonImage: '<?php echo IMAGES_DIR ;?>/calendar.gif', buttonImageOnly: true,
		                               changeMonth: true,
				                       changeYear: true,
				                       showButtonPanel: true,
...
$decID=$formdata['decID'];
		...
		$sql="SELECT forum_decName from forum_dec WHERE forum_decID=$frm_id ";
            ...
            <td   class="myformtd" id="myformtd">
			 ...
			 <div class="form-row"> 
			   <span class="h">חברי פורום בעת קבלת ההחלטה:<input id="forum_decName<?php echo $decID; ?>" name="forum_decName<?php echo $decID; ?>" type="text" value="<?php echo $forum_name;?>" class="mycontrol"/></span> 
			    <br/> 
             </div> 
...
<input type="button"  class="mybutton"  id="my_button_<?php echo $row->userID ;?>"  value="ערוך משתמש" onClick="return editReg_user(<?php echo $row->userID;?>,<?php echo " '".ROOT_WWW."/admin/' "; ?> );" ; return false;/ >
...
/****************************************************************************************************/
 ...
 echo '
   ...
   ?><tr><td  class="myformtd" ><table class="myformtable1" style="border:0;" id="conn_table<?php echo $decID;?>"><tr id="conn_tr<? echo $decID; ?>"><?php  
...
<tr><td  class="myformtd" id="my_td2<?PHP echo $decID;?>">
...
&nbsp;&nbsp;
<button class="green90x24" type="button" name="submitbutton1_<?php echo $formdata['decID'];?>"  id="submitbutton1_<?php echo $formdata['decID'];?>" >→משימות</button>
&nbsp;&nbsp;
<button class="green90x24" type="button" name="submitbutton2_<?php echo $formdata['decID'];?>"  id="submitbutton2_<?php echo $formdata['decID'];?>" >משימות←</button>
...
<button class="green90x24" type="submit" name="submitbutton3_<?php echo $formdata['decID'];?>"  id="submitbutton3_<?php echo $formdata['decID'];?>"
 ...
 -->
<button class="green90x24" type="submit" name="submitbutton3_<?php echo $formdata['decID'];?>"  id="submitbutton3_<?php echo $formdata['decID'];?>"  >העלה מידע</button> 
...
<button class="green90x24" type="submit" name="btnDelete__<?php echo $formdata['decID'];?>"  id="btnDelete_<?php echo $formdata['decID'];?>" >מחק החלטה</button>
<?php		
...
<table id="my_dec<?php echo $decID; ?>" style="width:100%;cursor:pointer"; > 
 <?php  	
 if(array_item($formdata,"dest_forums$decID") ){
 $i=0;	
	foreach($formdata["dest_forums$decID"] as $key=>$val ){
...
//	    	document.getElementById('mult_yearID'+decID).value="none";
//	    	document.getElementById('mult_monthID'+decID).value="none";
//	    	document.getElementById('mult_dayID'+decID).value="none";
//$('#my_find_ol').css('list-style','none');
...
//         if(!$('#mult_yearID'+decID).val()=="none")    
//	    	$('#mult_yearID'+decID).val()="none";
//
//          if(!$('#mult_monthID'+decID).val()=="none")
//	    	$('#mult_monthID'+decID).val()="none";
//
//          if(!$('#mult_dayID'+decID).val()=="none")
//	    	$('#mult_dayID'+decID).val()="none";
