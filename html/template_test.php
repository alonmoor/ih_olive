...
<!-- --------------------------------------------JEQUERY-------------------------------------------------------- -->	 
      ...
      <link rel="stylesheet" type="text/css" media="all"  href="<?php echo CSS_DIR ?>/themes/start/jquery-ui-1.8.14.custom.css"> 
   <script  language="JavaScript" src="<?php print JQ_ADMIN_WWW ?>/jquery-1.4.2.min.js"           type="text/javascript"> </script>
   <script  language="JavaScript" src="<?php print JQ_ADMIN_WWW ?>/jquery-ui-1.8.14.custom.min.js" charset="utf-8" type="text/javascript"></script>
...
<!--   <script  language="JavaScript" src="<?php print JQ_ADMIN_WWW ?>/ui.datepicker.js"        charset="utf-8"        type="text/javascript"></script>-->
...
<style type="text/css">
 body { 
 	 ...
 	 margin: 0px 0px 0px 0px;
		...
		/* background :  url('../images/b-grad-background.png#xywh=1000,3000,600,200') repeat-x ;*/
		/* background :#AE77BE ;F5E78E*/ 
	/*	background :#F5E78E ;*/
 	 
 	 /*background :#BBB8D6 ;*/
 	/* background :#F7D2F2 ;*/
 	  
 	background-image: url(../images/background/background-repeatx.jpg);
...
body,th,td {
  ...
  font-size: 12pt;/*size of the text*/
  color: #444444;
}
...
<fieldset  id="template_fieldset"  style="margin-left:10px;margin-right:10px;margin-top:15px;background: #94C5EB url(../images/background-grad.png) repeat-x;">
  ...
  <div id="sidebar_edit_template"  style="float:right;margin-right:52px;">
  ...
  <div id="sidebar_frm_template"  style="float:left;margin-left:52px;">
  ...
  <div id="sidebar_dec_template"  style="float:left;">
   ...
   <input type="text" name="search_dec_template" id="search_dec_template"  class="text ui-widget-content ui-corner-all"  style="direction:rtl;margin-bottom:10px;"/>
    ...
    <li id="navMenu1" class="menuHeader"  style="margin-top:30px;"><a  href="#">ראשי</a></li>
         
    <li id="navMenu2" class="menuHeader" style="margin-top:30px;"><a href="#">ניהול החלטות</a></li>
    <li id="navMenu3" class="menuHeader" style="margin-top:30px;"><a href="#">ניהול פורומים</a></li>
    <li id="navMenu4" class="menuHeader" style="margin-top:30px;"><a href="#">ניהול משתמשים</a></li>
    <li id="navMenu5" class="menuHeader" style="margin-top:30px;"><a href="#">חיפושים</a></li>
    <li id="navMenu6" class="menuHeader" style="margin-top:30px;"><a href="#">ניהול ובקרה</a></li>
...
<div class="page" id="template_page"></div> 
...
<table border="0" cellpadding="0" cellspacing="0"  id="alon" dir="rtl" align="center" style="width:95%;bottom:50px;">
