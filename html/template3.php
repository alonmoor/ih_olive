...
<link rel="stylesheet" type="text/css" media="screen"  href="<?php echo CSS_DIR ?>/input.css"  /> 
   <link rel="stylesheet" type="text/css" media="screen" href="<?php echo CSS_DIR ?>/form.css" />
    ...
    <link rel="stylesheet" type="text/css" media="screen"  href="<?php echo CSS_DIR ?>/DropDownMenu.css"  />
     <link rel="stylesheet" type="text/css" media="screen"  href="<?php echo CSS_DIR ?>/Menu.css"  />
  ...
  <div id="content_">
    <div class="sidebar_">
      ...
      <ul>
		...
		<li><a href="database.php" onfocus="if (this.blur) this.blur();">עץ ההחלטות</a></li>
		<li><a href="database7.php" onfocus="if (this.blur) this.blur();">עץ פתוח של החלטות</a></li>
		<li><a href="category_tree.php"">צפייה בעץ סוגי החלטות</a></li>
